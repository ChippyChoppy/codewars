...
for some reason) problem, but a quick recap for you: a young man asks as a compensation only 1 grain of rice 
for the first square, 2 grains for the second, 4 for the third, 8 for the fourth and so on, always doubling the previous.
...
function squaresNeeded(grains) {
  ...
  /*** Solution 2 --> binary conversion ***/
  function squaresNeeded(grains) {
    return !grains ? 0 : grains.toString(2).length
  }